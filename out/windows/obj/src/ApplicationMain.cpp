...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("OmegaEngine",e3,35,9d,d3),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("38",a5,2c,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("SidGames5",62,6a,e6,9d));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("OmegaEngine",e3,35,9d,d3));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Omega 1.0.0.0",58,91,34,ea));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.0.0.0",37,91,ce,1b));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),1600)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),900)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Omega 1.0.0.0",58,91,34,ea))
