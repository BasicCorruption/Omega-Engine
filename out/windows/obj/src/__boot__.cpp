...
::omega::engine::hub::window::MainUI_obj::__register();
...
::__ASSET__OPENFL__res_nokiafc22_ttf_obj::__register();
::__ASSET__OPENFL__res_monsterrat_ttf_obj::__register();
::__ASSET__res_nokiafc22_ttf_obj::__register();
::__ASSET__res_monsterrat_ttf_obj::__register();
...
::omega::engine::Main_obj::__register();
